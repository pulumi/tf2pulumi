...
// nolint: structcheck, NYI: TF12 modules
type module struct {
	syntax *hclsyntax.Block
...
var tf12builtins = map[string]*model.Function{
	...
	"element": model.NewFunction(model.GenericFunctionSignature(func(args []model.Expression) (model.StaticFunctionSignature, hcl.Diagnostics) {
		var diagnostics hcl.Diagnostics
	...
	"length": model.NewFunction(model.GenericFunctionSignature(func(args []model.Expression) (model.StaticFunctionSignature, hcl.Diagnostics) {
		var diagnostics hcl.Diagnostics
	...
	"lookup": model.NewFunction(model.GenericFunctionSignature(func(args []model.Expression) (model.StaticFunctionSignature, hcl.Diagnostics) {
		var diagnostics hcl.Diagnostics
