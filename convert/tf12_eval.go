...
func (analyzer *conditionalAnalyzer) isConditionalValue(n model.Expression) bool {
	model.VisitExpression(n, model.IdentityVisitor, analyzer.postVisit)
...
func (b *tf12binder) GetModuleInstance(addr addrs.ModuleCallInstance, r tfdiags.SourceRange) (cty.Value, tfdiags.Diagnostics) {
	return cty.UnknownVal(cty.DynamicPseudoType), nil
}

func (b *tf12binder) GetModuleInstanceOutput(addr addrs.ModuleCallOutput, r tfdiags.SourceRange) (cty.Value, tfdiags.Diagnostics) {
	return cty.UnknownVal(cty.DynamicPseudoType), nil
}
...
func (b *tf12binder) GetTerraformAttr(addr addrs.TerraformAttr, r tfdiags.SourceRange) (cty.Value, tfdiags.Diagnostics) {
	return cty.UnknownVal(cty.DynamicPseudoType), nil
}

func (b *tf12binder) GetInputVariable(addr addrs.InputVariable, r tfdiags.SourceRange) (cty.Value, tfdiags.Diagnostics) {
	return cty.UnknownVal(cty.DynamicPseudoType), nil
}
