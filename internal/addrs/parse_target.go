...
// must not be used.
func ParseTarget(traversal hcl.Traversal) (*Target, hcl.Diagnostics) {
...
func ParseTargetStr(str string) (*Target, hcl.Diagnostics) {
...
// must not be used.
func ParseAbsResource(traversal hcl.Traversal) (AbsResource, hcl.Diagnostics) {
...
// information.
func ParseAbsResourceStr(str string) (AbsResource, hcl.Diagnostics) {
	var diags hcl.Diagnostics
...
// If error diagnostics are returned then the AbsResource value is invalid and
// must not be used.
func ParseAbsResourceInstance(traversal hcl.Traversal) (AbsResourceInstance, hcl.Diagnostics) {
	addr, diags := ParseTarget(traversal)
	if diags.HasErrors() {
...
// any returned diagnostics will not have meaningful source location
// information.
func ParseAbsResourceInstanceStr(str string) (AbsResourceInstance, hcl.Diagnostics) {
	var diags hcl.Diagnostics
