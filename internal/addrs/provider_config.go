...
func ParseAbsProviderConfig(traversal hcl.Traversal) (AbsProviderConfig, hcl.Diagnostics) {
...
func ParseAbsProviderConfigStr(str string) (AbsProviderConfig, hcl.Diagnostics) {
...
func ParseLegacyAbsProviderConfigStr(str string) (AbsProviderConfig, hcl.Diagnostics) {
	var diags hcl.Diagnostics
...
// FQN.
func ParseLegacyAbsProviderConfig(traversal hcl.Traversal) (AbsProviderConfig, hcl.Diagnostics) {
	modInst, remain, diags := parseModuleInstancePrefix(traversal)
	var ret AbsProviderConfig
