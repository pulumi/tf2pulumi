...
func ParseModuleInstanceStr(str string) (ModuleInstance, hcl.Diagnostics) {
...
func parseModuleInstancePrefix(traversal hcl.Traversal) (ModuleInstance, hcl.Traversal, hcl.Diagnostics) {
	remain := traversal
